...
/*   Updated: 2024/02/16 12:03:40 by yel-yaqi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	zoom(t_pixels **pixels, int r, int c, int zm)
{
	...
	while (i < r)
	{
		...
		while (j < c)
		{
			pixels[i][j].y_transform = pixels[i][j].x * zm;
			pixels[i][j].z_transform = pixels[i][j].y * zm;
			pixels[i][j].x_transform = pixels[i][j].z * zm;
